...
#' @describeIn sidebar_menu_output Create a sidebar menu output (alias for \code{sidebar_menu
...
#' @describeIn menu_item_output Create a menu item output (alias for \code{menu_item_output} for
...
#' @describeIn render_menu Create a menu output (alias for \code{render_menu} for compatibility
