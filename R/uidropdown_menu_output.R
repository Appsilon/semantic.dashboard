#' Create a dropdown menu output (alias for \code{value_box_output} for compatibility with \code{shinydashboard})
...
#' @return A dynamic dropdown menu that can be assign to output.
#' @export
